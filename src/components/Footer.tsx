        ...
        <div className="flex">
            <footer className="border-t-2 border-[#141414] bg-black hover:text-white w-screen" >
                <div className="ml-12 py-2 mr-12">
                        <div className='flex flex-row mx-4 md:items-start pb-0'>
                            <div className="md:ml-2 mb-6 m-1 sm:text-left font-normal tracking-tight text-secondary">
                            ...
                            <div className='absolute right-0 mt-2 pr-4'>
